...
# 更改时间 , 需要统一时间，方便后期使用。
TimeRange = pd.date_range(start="18500101", end="20141231", freq="MS")
...
Nino34ID.to_netcdf("/content/DL/TrainData/Cmip6Nino34I.nc")

TosAD = xr.Dataset({"TosA": TosAInterped})
ZosAD = xr.Dataset({"ZosA": ZosAInterped})
TosAD.to_netcdf("/content/DL/TrainData/TosA.nc")
ZosAD.to_netcdf("/content/DL/TrainData/ZosA.nc")
